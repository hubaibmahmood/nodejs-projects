...
async function perform(operator:string, num1: number, num2: number){
...
async function add(num1:number, num2:number, spinner: any){
...
async function subtract(num1:number, num2:number , spinner: any){
...
async function multiply(num1: number, num2: number, spinner: any){
...
async function divide(num1: number, num2: number, spinner: any){
